package com.bskj.mysheetdialog.view;
...
public class CustomProgressBar extends View {
    ...
    public void upDateCurProgress (final int progress) {

        ObjectAnimator animator = ObjectAnimator.ofInt(this, "progress", progress).setDuration(100);
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
