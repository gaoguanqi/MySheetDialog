...
public class SmartisanDialogActivity extends AppCompatActivity {

    private Context ctx;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_smartisan_dialog);
        ctx = this;
    }
    ...
    public void normalDialog(View view) {
        ...
        dialog.setOnSelectListener(new NormalDialog.OnSelectListener() {
            ...
            public void onLeftSelect() {
                Toast.makeText(ctx, "onLeftSelect", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }

            @Override
            public void onRightSelect() {
                Toast.makeText(ctx, "onRightSelect", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    }
    ...
    public void twoOptionsDialog(View view) {
        ...
        dialog.setOnSelectListener(new TwoOptionsDialog.OnSelectListener() {
            @Override
            public void onOp1() {
                Toast.makeText(ctx, "onOp1", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }

            @Override
            public void onOp2() {
                Toast.makeText(ctx, "onOp2", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    }
    ...
    public void threeOptionsDialog(View view) {
        ...
        dialog.setOnSelectListener(new ThreeOptionsDialog.OnSelectListener() {
            ...
            @Override
            public void onOp3() {
                Toast.makeText(ctx, "onOp3", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    }
    ...
    public void warningDialog(View view) {
        ...
        dialog.setOnConfirmListener(new WarningDialog.OnConfirmListener() {
            ...
            public void onConfirm() {
                Toast.makeText(ctx, "onConfirm", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    }
    ...
    public void optionListDialog(View view) {
        ...
        dialog.setOnOptionItemSelectListener(new OnOptionItemSelectListener() {
            ...
            public void onSelect(int position, CharSequence option) {
                Toast.makeText(ctx, "position = " + position + ", option = " + option, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
